...
export default function decorate(block) {
  ...
  let getFirstDivs = block.querySelectorAll('.c-dropdownbox-container .block > div > div:nth-child(1)');
  ...
  let getFirstTabs = block.querySelectorAll('.c-dropdownbox-container .block > div:first-child');
